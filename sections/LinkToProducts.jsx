    ...
    <div className="relative h-96">
      <div>
        <Carousel dots={false} dotPosition="top" autoplay>
          <div className="font-poppins bg-yellow-400 h-96">Pict 1</div>
          <div className="font-poppins bg-yellow-200 h-96">Pict 2</div>
          <div className="font-poppins bg-yellow-400 h-96">Pict 3</div>
