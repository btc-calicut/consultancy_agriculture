        ...
        <div className=" py-3 xs:py-7 px-4 sm:px-10 md:px-14 lg:px-36">
          <div className="flex flex-col xs:items-start h-full">
            <div className="flex flex-col py-2 gap-x-3 max-lg:gap-y-5">
              <h1 className="max-xs:pl-4 text-[40px] xs:text-[40px] font-[1000] sm:leading-20 lg:leading-loose bg-gradient-to-r from-sky-400 via-teal-200 to-white bg-clip-text text-transparent drop-shadow-[0_5px_1.2px_rgba(0,0,0,0.8)] text-left font-poppins">
