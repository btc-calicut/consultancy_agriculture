...
const Enquiry = () => {
  ...
  return (
    <div id="enquiry" className="bg-zinc-100 w-full h-full">
      <div className="px-5 sm:px-10 md:px-14 lg:px-36 py-10">
        <div className="grid grid-cols-1 md:grid-cols-5 md:gap-x-4 lg:gap-x-16 gap-y-5">
          <div className="mx-3 sm:my-3 grid grid-cols-1 sm:col-span-2 text-center">
            <h1 className="text-indigo-900 font-sans max-sm:mb-4 text-[35px] tracking-wide leading-relaxed font-bold">
              Get in Touch!
            </h1>
                    ...
                    <div key={index}>
                      <div className="md:h-80 flex md:flex-col text-center items-center justify-center gap-y-6">
                        ...
                        <div className="mx-2 flex flex-col justify-center font-poppins">
                          ...
                          <p className="text-sm sm:text-lg">{employee.name}</p>
